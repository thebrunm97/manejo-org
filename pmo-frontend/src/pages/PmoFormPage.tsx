            ...
            <div className="p-2 mb-3 flex flex-col md:flex-row items-start md:items-center gap-3">
                ...
                <div className="w-full md:w-[350px]">
                    ...
                    <input
                        ...
                        className="w-full border border-gray-300 rounded-md p-2.5 text-sm bg-white text-gray-900 shadow-sm focus:ring-1 focus:ring-green-500 focus:border-green-500"
                    />
                </div>
            </div>
