                            ...
                            properties.map((item) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {isSelected && <Chip label="Visível" size="small" sx={{ bgcolor: '#4ade80', color: '#064e3b', fontWeight: 'bold' }} />}
                                    </Box>
                                );
                            })
                        )}
                    ...
                    {selectedProperty ? (
                        <Box sx={{ textAlign: 'center', p: 2 }}>
                            ...
                            <Box sx={{ mt: 4, p: 4, border: '2px dashed rgba(255,255,255,0.2)', borderRadius: 4, bgcolor: 'rgba(0,0,0,0.2)' }}>
                                ...
                                <Typography variant="caption" display="block" sx={{ color: 'rgba(255,255,255,0.5)' }}>Componente de Mapa (React Leaflet) será injetado aqui.</Typography>
                            </Box>
                        </Box>
                    ) : (
                        <Box sx={{ textAlign: 'center', opacity: 0.5 }}>
                            <PublicIcon sx={{ fontSize: 120, color: 'white', mb: 2 }} />
                            <Typography variant="h5" sx={{ color: 'rgba(255,255,255,0.8)' }}>👈 Selecione uma propriedade na lista</Typography>
                        </Box>
                    )}
