...
const FastInput = React.memo(({ value, onChange, onBlur, type = 'text', multiline = false, rows = 1, suffix, className = '', ...props }: any) => {
    ...
    const inputCls = `w-full bg-white border border-gray-200 focus:ring-1 focus:ring-green-500 focus:border-green-500 rounded p-1.5 text-sm text-gray-900 ${className}`;
        ...
        if (col.type === 'select') {
            ...
            return (
                <select
                    ...
                    onBlur={onBlurCmd}
                    className="w-full border border-gray-200 rounded p-1.5 text-sm bg-white text-gray-900 focus:ring-1 focus:ring-green-500 focus:border-green-500"
                >
            ...
            return (
                <div className="flex items-center gap-1">
                    ...
                    <select
                        ...
                        onBlur={onBlurCmd}
                        className="border border-gray-200 rounded p-1.5 text-sm bg-white text-gray-900 min-w-[70px] focus:ring-1 focus:ring-green-500"
                    >
                ...
                {localData.map((item) => {
                    ...
                    return (
                        ...
                        >
                            {/* Card Header */}
                            <div
                                className={`flex items-center gap-3 px-4 py-3 ${isOpen ? 'bg-white' : 'bg-gray-50'} ${hasRowClick && !isOpen ? 'cursor-pointer hover:bg-gray-100' : ''
                                    } transition-colors`}
                                onClick={() => {
