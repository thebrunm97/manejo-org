...
describe('Secao4', () => {
    test('deve atualizar o radio de ha_animais', () => {
        ...
        render(<Secao4 data={data} onSectionChange={mockOnSectionChange} />);
    ...
    test('deve renderizar subseções apenas quando Sim é selecionado', () => {
        ...
        const { rerender } = render(<Secao4 data={dataFalse} onSectionChange={mockOnSectionChange} />);
        ...
        rerender(<Secao4 data={dataTrue} onSectionChange={mockOnSectionChange} />);
