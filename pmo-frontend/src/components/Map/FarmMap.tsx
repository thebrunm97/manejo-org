                ...
                return (
                    ...
                    >
                        {selecionado ? (
                            ...
                            // Área de toque de 44x44 (mínimo do projeto para elementos
                            // tocáveis) em volta do pino visual de 32px: no mouse do
                            // desktop 32px basta, mas no dedo é fácil errar por poucos
                            // pixels e o toque cair no mapa por baixo em vez do marcador.
                            <span
