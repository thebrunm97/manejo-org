...
func handleLimpeza(ctx context.Context, ext *groq.ExtractionResult, profile *supabase.Profile, sbClient *supabase.Client, _ ports.ChannelSender, _ ports.Synthesizer, _ string, body string, _ bool, startTime time.Time, modelConfigured string, modelEffective string, pTokens int, cTokens int) (string, ProcessResult) {
